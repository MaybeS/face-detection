...
flags.DEFINE_string("pascal", "../data", "path to training set")
...
flags.DEFINE_boolean("merge", False, "merge box or not?")
...
FLAGS = flags.FLAGS
image = FLAGS.pascal + '/face-a/'
annot = FLAGS.pascal + '/face-x/' + 'parsed.yolotf'
